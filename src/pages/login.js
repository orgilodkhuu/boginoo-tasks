    ...
    return (
        <Layout>
            <div className='h100 flex flex-col justify-center items-center'>
                ...
                <div className='mt font-ubuntu fs-20 lh-23 bold c-primary'>
                    Нэвтрэх
                </div>
                <InputForm label="Цахим хаяг" className="input b-gray0 h-5 w-8 " placeholder='name@mail.domain' type="email" onChange={change} id="email" />
                ...
                <Button className={"mt font-ubuntu fs-20 lh-23 bold c-default h-5 ph-4 ml-4 b-primary" } onClick={login}>Нэвтрэх</Button>
